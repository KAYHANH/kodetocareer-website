...
const COURSES: Course[] = [
  ...
  },
  {
    ...
    rating: 4.7,
    reviews: 58,
    internship: "Lab Sprints Available",
    placement: "Placement Auditing",
    skills: ["Ethical Hacking", "Kali Linux", "Network Security", "Metasploit", "Penetration Testing"],
    difficulty: "Beginner",
    tagline: "Become a professional Cyber Security Analyst with our networking, penetration testing, and labs course.",
    desc: "Master system defense vulnerabilities, audit networks, perform penetration testing inside simulated cyber ranges, and write security reports.",
    color: "from-red-500/10 to-rose-500/10 border-red-100",
    priceUpfront: "₹10,000",
    pricePlaced: "₹0",
    oldPrice: "₹20,000",
    badge: "Defensive Core",
    liveClasses: "Lab Cohort",
    mentor: "Certified Analysts",
    tools: ["Docker.svg", "Git.svg"],
    image: "from-red-600 to-zinc-800"
  },
  {
    id: 8,
