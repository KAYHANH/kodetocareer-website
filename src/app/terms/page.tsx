  ...
  return (
    <div className="min-h-screen bg-background pt-10 pb-24 relative overflow-hidden">
      <div className="max-w-[800px] mx-auto px-6 relative z-10">
        <h1 className="text-4xl font-heading font-black text-slate-900 mb-8">Terms of Service</h1>

        <div className="prose text-slate-500 font-semibold space-y-6 text-sm leading-relaxed">
          <p>Last updated: July 1, 2026</p>

          <section className="space-y-3">
            <h2 className="text-xl font-heading font-extrabold text-slate-900">1. Agreement to Terms</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-heading font-extrabold text-slate-900">2. Eligibility & Account</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-heading font-extrabold text-slate-900">3. Course Registration & Payments</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-heading font-extrabold text-slate-900">4. Placement Assistance Policy</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-heading font-extrabold text-slate-900">5. Limitation of Liability</h2>
          ...
          <section className="space-y-3">
            <h2 className="text-xl font-heading font-extrabold text-slate-900">6. Changes to Terms</h2>
