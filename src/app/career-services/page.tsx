            ...
            {MENTORS.map((m, idx) => (
              <div key={idx} className="bg-white border border-slate-150 p-5 rounded-2xl flex items-center gap-4 shadow-sm hover:shadow-md transition-shadow">
                ...
                <div>
                  ...
                  <span className="text-[10px] text-slate-450 font-bold block mt-1">{m.role}</span>
        ...
        <section className="space-y-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { name: "Rahul Sharma", role: "Full Stack Developer", target: "Google", package: "₹12 LPA", text: "From local scripting to architecting production apps at Google. The resume workshops and mockup interviews were critical." }
            ].map((s, idx) => (
                ...
                <div className="flex justify-between items-center">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <span className="text-[9px] text-slate-400 font-bold block mt-0.5">{s.role}</span>
                    </div>
                  </div>
